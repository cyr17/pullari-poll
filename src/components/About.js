...
<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
  <div>
    ...
    <p>
      Pulari refers to the collective efforts of members and volunteers when it comes to addressing any challenges that come through when organising any large events. Annual stage shows showcased every year are one such event that has continued its success from the time when the community. Apart from cultural events and other community programs Pulari Victoria also focuses its attention on charity donations both within Australia and internationally.
    </p>
  </div>
  <div className="bg-gray-300 flex items-center justify-center h-fit">
    <img src="/guests.jpg" alt="Placeholder image for Pulari Victoria Inc" className="w-full h-full object-cover" />
  </div>
</div>
        </div>
    );
